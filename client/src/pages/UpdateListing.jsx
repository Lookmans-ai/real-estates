...
import { fetchListing, updateListing } from '../redux/listing/listingSlice.js';
...
export default function UpdateListing() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/listing/${actionResult.listing._id}`);
    } catch (rejectedValue) {
      setMessage(rejectedValue || 'Failed to update listing.');
      setIsError(true);
    }
  };
